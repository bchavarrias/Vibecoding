...
export default function FinalCta() {
  ...
  return (
    <section className="relative overflow-hidden border-t border-base-200 bg-base-100" aria-labelledby="final-cta-heading">
      <div
      ...
      <div className="mx-auto max-w-3xl px-4 py-20 text-center md:py-28">
        ...
        <h2 id="final-cta-heading" className="mt-3 text-balance text-3xl font-bold tracking-tight md:text-5xl">
          {title}
        </h2>
        {subtitle && (
